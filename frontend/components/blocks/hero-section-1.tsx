                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">View My Projects</span>
                                    ...
                                    <p
                                        ...
                                        Building modern web applications with Next.js, TypeScript, and cutting-edge technologies. Explore my projects and see what I can create.
                                    </p>
                                </AnimatedGroup>
